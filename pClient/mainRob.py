...
class MyRob(CRobLinkAngs):
    ...
    def run(self):
        ...
        while True:
            self.readSensors()
            #print line sensors
            print('Line sensors: ' + str(self.measures.lineSensor))
            print('Estado:'+state)
    ...
    def wander(self):
        ...
        #print('IR sensors: ' + str(self.measures.irSensor))
